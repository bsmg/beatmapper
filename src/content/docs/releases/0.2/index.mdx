...
> [!note]
> Beatmapper is still in Alpha - this is v0.2, not v2.0. All the usual caveats apply!
...
Using the keyboard shortcuts <Shortcut>a</Shortcut> and <Shortcut>s</Shortcut>, you can toggle between "Add" and "Select" modes in the lighting event tab.
...
To create a bookmark, press <Shortcut>meta+b</Shortcut> and give it a name.
...
For a better list of recent improvements, check out the [Keyboard Shortcuts](/docs/shortcuts) docs; most new features have an associated keyboard shortcut 🎉

> [!note]
> This changelog was ported from the tagged release via the original GitHub repository: https://github.com/joshwcomeau/beatmapper/releases/tag/0.2.0