...
- The file upload components have been given new improvements and automations for uploaded files:
  ...
  - Cover art files will automatically crop themselves to a square aspect ratio.
