...
To use Mapping Extensions, first you have to enable it for your map in the "Advanced Settings" tab of the "Details" view:

![](../../media/images/extensions-module.png)

> [!important]
> Placing any objects with this setting active will mean that only users who have Mapping Extensions enabled will be able to play your map. 
> Some users will not be able to play your map if you tick this box.
