...
To open files in Audacity, you can use the platform-appropriate shortcut <Shortcut>meta+o</Shortcut>, or use `File -> Open…` from the top menu. After selecting your MP3 or WAV file, you should see a view like this:

![](./images/audacity-intro.png "This guide was written using MacOS, but the instructions should be the same for any OS")
...
<audio controls src='./audio/explain-offset.mp3' />
...
![](./images/beatport-bpm.jpg "'BPM' is highlighted under the waveform")
...
![](./images/only-now-zoomed-out.png)
...
<audio controls src='./audio/fade-out.mp3' />
...
![](./images/bad-computer-waveform.png)
...
![](./images/bad-computer-waveform-annotated.png)
...
![](./images/bad-computer-waveform-tweaked.png)
...
Now that you've gotten an appropriate `.ogg` song track, and you know its BPM and offset, it's time to start mapping! Our [User Manual](/docs/manual/getting-started#creating-our-song) picks up from this point.
