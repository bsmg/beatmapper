...
> Simply click the "Terminal" tab in the menu bar and select the "New Terminal" option or press <Shortcut>mod+shift+`</Shortcut> to create a new terminal instance.
...
The process can also be interrupted with <Shortcut>mod+c</Shortcut>, if you wish to stop the server without closing the window.
