...
## Is the editor still maintained?
...
A [compatibility guide](/docs/migration#compatibility) is available that outlines what newer beatmap features are planned and/or supported by the editor for the current update, 
...
Alternatively, if you have the expertise and would like to help accelerate the progress on features currently in the backlog,
you're welcome to [contribute to ongoing development directly](https://github.com/bsmg/beatmapper/blob/master/CONTRIBUTING.md) 
and/or reach out if you have any potential questions you have regarding ongoing or future development.
