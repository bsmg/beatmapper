...
category: manual
order: 1
next: manual/navigating-the-editor
---
...
You can also import a map you've downloaded from [BeatSaver](https://beatsaver.com/), or created using another mapper. Beatmapper doesn't support mapping extensions, or any other custom mods, but any map that works in vanilla Beat Saber should be loadable and editable.
...
![Google Images search](./images/google-image-search.png)
...
![A search on Unsplash.com](./images/unsplash.png "Unsplash has many beautiful images")
...
The [Basic Audio](https://bsmg.wiki/mapping/basic-audio) guide on the BSMG Wiki covers this process in depth. If you're new to mapping, I'd recommend reading that guide in full, and then coming back here armed with a song file and all the info we need.
...
![New song modal](./images/new-song-modal.png)
...
It's important to get the BPM and Offset values correct. For more information on these values, please consult the [Basic Audio](https://bsmg.wiki/mapping/basic-audio) guide.
