...
You can download your map at any time using <Shortcut>meta+s</Shortcut>. **It's recommended that you save often**; while not super common, the browser may occasionally decide to empty out the locally-persisted data, which includes all your work on your maps!
