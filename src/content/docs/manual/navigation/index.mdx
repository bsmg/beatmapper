...
In the top-right of the main view, it'll display some basic information about your map, including the cover image and song title.

Below the song info, you'll find a dropdown with all of your available beatmaps, 
where you can swap between them at will or click the button beside it to add new beatmaps directly from the main view.
...
> [!tip]
> You can also shift between snapping intervals by holding <Shortcut>mod</Shortcut> and spinning the mousewheel.
...
At any point, you can press <Shortcut>shift+backspace</Shortcut> to reset the camera's position to the default head-on view.
...
- **Controls**: for everything related to hotkeys and user input, such as obstacle placement modes.
