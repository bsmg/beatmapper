...
> Important note: the "Editor Offset" field is a cosmetic field used to line up the visual beat markers of the editor with the audio file. 
...
> In order to properly prevent a hot start, you will need to add silence using a proper audio editing tool and consult the Basic Audio guide linked above.
