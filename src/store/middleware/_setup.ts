...
export function createAppMiddleware({ extraArgument: extra }: Options) {
	...
	return [stateSyncMiddleware as Middleware, sharedMiddleware, audioMiddleware, playbackMiddleware, fileMiddleware, downloadMiddleware, historyMiddleware, backupMiddleware];
}
