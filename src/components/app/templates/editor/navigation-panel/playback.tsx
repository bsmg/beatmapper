...
function EditorNavigationControls() {
	...
	return (
		<Wrapper>
			<Column>
				<Select unfocusOnPress collection={SNAPPING_INCREMENT_LIST_COLLECTION} value={[snapTo.toString()]} onValueChange={(ev) => dispatch(updateSnap({ value: Number.parseFloat(ev.value[0]) }))}>
					Snap To
				</Select>
			</Column>
			<Column>
