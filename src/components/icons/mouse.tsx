...
function Mouse({ width = 18, height = 39, activeButton }: Assign<LucideProps, Props>) {
	return (
		<Wrapper role="presentation" width={width} height={height} viewBox="0 0 18 39" fill="none">
